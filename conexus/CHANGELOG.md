...
bead nexus-bc7ps. Plugin version aligned with conexus 7.50.0. No plugin-side
changes; `PENDING_RELEASE.md` held nothing at this cut.
...
release; the catalog and aspect-worker work is all client-side. The pin
advance carries the version only, so `conexus/PENDING_RELEASE.md` is empty at
this pin.

## [7.16.3] - 2026-08-24

Plugin version aligned with conexus 7.16.3. No plugin-surface changes this
release; the fixes are all client-side. The pin advance carries the version
only, so `conexus/PENDING_RELEASE.md` is empty at this pin.
...
MCP-server hotfix (mcp<2 pin + doctor/MVV handshake probes, nexus-l2ku5).
...
the root CHANGELOG for engine convergence on upgrade (the GH #1402
delivery fix) in this release.
...
Plugin version aligned with conexus 6.3.8. No plugin-side changes.

## [6.3.7] - 2026-07-07

Plugin version aligned with conexus 6.3.7. No plugin-side changes.
...
Plugin version aligned with conexus 6.3.4. No plugin-side changes.

## [6.3.3] - 2026-07-06

Plugin version aligned with conexus 6.3.3. No plugin-side changes.
