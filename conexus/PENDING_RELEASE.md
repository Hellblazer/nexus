...
- `conexus/skills/rdr-audit/SKILL.md` — nexus-ayfxh: bead sweeps must query both case forms of RDR tokens and never bare numbers (bd search is case-sensitive; cross-project RDR-number collisions).
