...
- `hooks/scripts/expectations.sh` — BEHAVIOURAL: the SubagentStop
  ...
  credit settlement (order-independent, zero false-block; nexus-rkigh) with
  a bounded lockdir around the read-decide-append (nexus-bk974), and
...
- `hooks/scripts/pre_close_verification_hook.sh` — BEHAVIOURAL: exports
  ...
  advisory-only; record: T2 nexus/f7xyq-6a19f-release-skew-record.
