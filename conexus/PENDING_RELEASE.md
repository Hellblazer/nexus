...
- `conexus/agents/code-review-expert.md` — three additions to the
...
- `conexus/agents/test-validator.md` — new section for a test that MEASURES
  rather than asserts: gate the setup (coverage, identity, isolation,
  well-formedness), not only the result.
- `conexus/agents/substantive-critic.md` — premise check placed ahead of every
  other deconstruction method, plus unenforced-prose-assumptions as the critic's
