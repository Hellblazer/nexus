...
- `conexus/skills/peer-messaging/SKILL.md`: "the armed mailbox watcher" is replaced with "the channel push", matching the RDR-211 delivery model (RDR-211 Phase 1 Step 4, bead nexus-rplay.15).
