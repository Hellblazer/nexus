...
- `conexus/hooks/scripts/rdr_hook.py` — SessionStart text names `nx index repo <root>` alone; `nx catalog setup` is retired and its mention was the false remedy (the false NOT-indexed verdict itself is nexus-owna8)
