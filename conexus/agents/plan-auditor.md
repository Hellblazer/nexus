...
name: plan-auditor
version: "3.0"
description: "STUB — superseded by mcp__plugin_nx_nexus__nx_plan_audit MCP tool (RDR-080 P3). Call mcp__plugin_nx_nexus__nx_plan_audit instead of dispatching this agent."
model: sonnet
color: orange
---
...
- Call `mcp__plugin_nx_nexus__nx_plan_audit` directly — no persistence from this stub.
