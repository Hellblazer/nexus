...
- **Quality Metrics**: Store in T2 memory: mcp__plugin_conexus_nexus__memory_put(content="metrics", project="{project}", title="test-metrics.md"
- **Recurring Patterns**: Store test quality patterns in T3 for reuse across sessions:
