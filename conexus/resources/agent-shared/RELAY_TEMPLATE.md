...
If validation fails:
1. Search T3 store for missing context: Use search tool: query="[task topic]", corpus="knowledge", limit=5
2. Check T2 memory: Use memory_get tool: project="{project}", title="ACTIVE_INDEX.md"
