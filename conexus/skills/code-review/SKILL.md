...
- **nx store** (optional): store_put tool: content="...", collection="<subject>", title="pattern-code-{topic}", tags="pattern,code-review" — recurring violation patterns worth long-term storage
