...
5. Persist findings to nx store: mcp__plugin_conexus_nexus__store_put(content="...", collection="<subject>", title="architecture-{project}-{component}", tags="architecture"
