...
- **T3 knowledge**: Root cause analysis via store_put tool: content="# Debug: {issue}\nRoot cause: {cause}", collection="<subject>", title="debug-finding-{issue}", tags="debug" and prevention patterns via store_put tool: content="# Prevention: {topic}\n{pattern}", collection="<subject>", title="pattern-prevention-{topic}", tags="pattern,prevention"
