...
- [ ] Every residual dispositioned by a change to the RDR file names its `{id}-fix-check-<sha>` record, its counted BLOCKS-PLANNING defects closed or recorded as residuals; a residual dispositioned by a bead id needs none
