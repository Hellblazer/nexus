...
- For every check, bound or rule this change adds, name the parameter, column or setting it constrains, and for every parameter, column or setting this change adds or alters, name every check, bound or rule that constrains it, whether or not they share a name.
