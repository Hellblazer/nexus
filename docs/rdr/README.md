...
| [RDR-151](rdr-151-daemon-event-loop-selector-spin-write-contention.md) | Daemon Event-Loop Selector Busy-Loop and Write-Lock Contention: Root-Cause Fix for the Recurring T2 Daemon 100% CPU Peg and Multi-Daemon database-is-locked Cascade | Architecture | Accepted | 2026-06-05 |
...
| [RDR-168](rdr-168-service-mode-catalog-interface-conformance.md) | Service-Mode Catalog Interface Conformance: Make HttpCatalogClient a Faithful Drop-In for the Local Catalog, Enforced by a Signature-Conformance Test | Bug Fix | Accepted | 2026-06-25 |
