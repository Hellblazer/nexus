...
| [RDR-152](rdr-152-postgres-java-storage-service.md) | Postgres + Java Storage Service + Thin HTTP Bridge: Replace the SQLite Single-Writer Daemon Class with a Multi-Tenant Postgres Substrate Owned by One Strict Java Service | Architecture | Accepted | 2026-06-06 |
