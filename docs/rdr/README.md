...
| [RDR-180](rdr-180-content-address-chash-binary-32byte.md) | Content-Address Chunks by a Canonical 32-Byte Binary chash: One Digest, Stored as Bytes, Hex Only at the Boundary | Architecture | Draft | 2026-07-04 |
...
| [RDR-185](rdr-185-single-ladder-convergent-upgrade.md) | Single-Ladder Convergent Upgrade: One Version, Auto-Applied Data Migrations, Delete the Upgrade Ceremony | Architecture | Accepted | 2026-07-16 |
