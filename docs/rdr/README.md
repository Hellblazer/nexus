...
| [RDR-180](rdr-180-content-address-chash-binary-32byte.md) | Content-Address Chunks by a Canonical 32-Byte Binary chash: One Digest, Stored as Bytes, Hex Only at the Boundary | Architecture | Accepted | 2026-07-04 |
