...
| [RDR-141](rdr-141-t2-version-skew-double-writer.md) | T2 Version-Skew Double-Writer: Split t2_index_write Exception Arms + Self-Healing Daemon Re-Assert | Architecture | Accepted | 2026-06-01 |
