...
| [RDR-174](rdr-174-unified-nx-init-service-lifecycle.md) | Unified nx init and Service-Supervisor Lifecycle: Collapse the Install to One Command and Close the Reboot-Persistence Gap | Architecture | Accepted | 2026-06-28 |
| [RDR-175](rdr-175-os-init-single-process-watchdog.md) | OS-Init as the Single Process Watchdog: Retire the In-Process Storage-Supervisor Respawn Layer | Technical Debt | Accepted | 2026-06-28 |
