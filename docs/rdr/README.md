...
| [RDR-160](rdr-160-bge-768-local-service-embedder.md) | bge-768 as the Local-Mode T3 Embedder in the Java Service: Replace MiniLM-384 ONNX, Parity-Gated Against fastembed | Architecture | Accepted | 2026-06-15 |
