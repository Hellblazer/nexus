...
| [RDR-169](rdr-169-docuverse-storage-reference-only-chunks.md) | Docuverse Storage: Reference-Only Chunks — Retention Enum, Nullable Content, Reference-Only Search DTO, and the URI-Resolver / Embed-Without-Store Surface | Architecture | Draft | 2026-06-25 |
