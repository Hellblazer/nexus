...
| [RDR-217](rdr-217-client-lexical-retrieval-leg.md) | A Lexical Leg for the nexus Client: Reach the Engine's FTS Hybrid Route | Feature | Accepted | 2026-09-19 |
| [RDR-218](rdr-218-windows-platform-support.md) | Windows Platform Support: a Low-Friction Plugin Install for the CLI and the Desktop | Architecture | Draft | 2026-09-21 |
