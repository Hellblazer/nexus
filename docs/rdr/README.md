...
| [RDR-143](rdr-143-plugin-cli-version-lockstep.md) | Plugin↔CLI Version Lockstep: a SessionStart Version-Marker Hook That Keeps the nx CLI in Sync With the conexus Plugin | Architecture | Draft | 2026-06-01 |
| [RDR-144](rdr-144-guided-onboarding-embedder-provisioning.md) | Guided Install / Onboarding & Local-Embedder Provisioning (nx init): Make the 384-vs-768 Embedder an Explicit Guided Choice | Architecture | Accepted | 2026-06-01 |
