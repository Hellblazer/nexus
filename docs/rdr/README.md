...
| [RDR-079](rdr-079-operator-dispatch-and-execution.md) | Operator Dispatch + Plan Execution End-to-End | Feature | Accepted | 2026-04-15 |
| [RDR-080](rdr-080-retrieval-layer-consolidation.md) | Retrieval Layer Consolidation — `nx_answer` + Agent/Skill Pruning | Feature | Draft | 2026-04-15 |
| [RDR-081](rdr-081-authoring-trust-cli.md) | Authoring-Trust CLI — Glossary-Aware Labeler, Stale-Reference Validator, Model Upgrade | Feature | Draft | 2026-04-15 |
