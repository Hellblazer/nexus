...
| [RDR-172](rdr-172-service-mode-aspect-enqueue-silent-failure.md) | Service-Mode Aspect-Enqueue Silent Failure: store_put's Enqueue 500s on the RDR-156 doc_id FK and the Hook Swallows It | Architecture | Draft | 2026-06-27 |
