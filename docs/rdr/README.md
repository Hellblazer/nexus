...
| [RDR-153](rdr-153-migration-data-quality-policy.md) | Migration Data-Quality Policy and Structured Issue Reporting for the SQLite→Postgres T2 Migration | Feature | Accepted | 2026-06-08 |
| [RDR-154](rdr-154-deliberate-postgres-capability-leverage.md) | Deliberate Postgres-Capability Leverage for the RDR-152 Schema — Computed Views, Trigger-Maintained Invariants, security_invoker Discipline, and Counter-Drift Elimination | Architecture | Draft | 2026-06-08 |
