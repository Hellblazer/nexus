...
| [RDR-172](rdr-172-service-mode-aspect-enqueue-silent-failure.md) | Service-Mode Aspect-Enqueue Silent Failure: store_put's Enqueue 500s on the RDR-156 doc_id FK and the Hook Swallows It | Architecture | Accepted | 2026-06-27 |
| [RDR-173](rdr-173-service-mode-aspect-worker-hosting.md) | Aspect-Worker Hosting in the Post-RDR-152 Service Topology: The Extraction Worker Has No Persistent Host, So Short-Lived Store Paths Never Extract | Architecture | Accepted | 2026-06-28 |
...
| [RDR-176](rdr-176-survivable-managed-migration-readiness.md) | Survivable Managed-Migration Readiness: Batched ETL, First-Class Downgrade with an Immutable Source, Unified Config-First Auth, Edge Route Coverage, and Migration Observability | Architecture | Accepted | 2026-06-30 |
