...
| [RDR-140](rdr-140-t2-daemon-supervisor-ownership-model.md) | T2 Daemon Supervisor & Ownership Model: Single-Flight Election to End the Spawn-Race / SQLite-Lock Thrash | Architecture | Draft | 2026-05-31 |
