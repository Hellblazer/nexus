...
| [RDR-142](rdr-142-migration-completeness-vs-version-row.md) | Migration Completeness vs the Version Row: apply_pending Advances `_nexus_version` While Deferred/Gated Steps Remain | Architecture | Draft | 2026-06-01 |
