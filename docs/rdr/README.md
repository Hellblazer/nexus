...
| [RDR-170](rdr-170-migration-application-not-gated-on-package-version.md) | T2 Migration Application Must Not Gate on Package Version: Drop the apply_pending Upper Bound | Architecture | Accepted | 2026-06-25 |
