...
| [RDR-143](rdr-143-plugin-cli-version-lockstep.md) | Plugin↔CLI Version Lockstep: a SessionStart Version-Marker Hook That Keeps the nx CLI in Sync With the conexus Plugin | Architecture | Accepted | 2026-06-01 |
