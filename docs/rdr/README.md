...
| [RDR-168](rdr-168-service-mode-catalog-interface-conformance.md) | Service-Mode Catalog Interface Conformance: Make HttpCatalogClient a Faithful Drop-In for the Local Catalog, Enforced by a Signature-Conformance Test | Bug Fix | Draft | 2026-06-25 |
