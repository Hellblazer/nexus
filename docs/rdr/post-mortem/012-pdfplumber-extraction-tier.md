...
`/conexus:rdr-close` for any extraction-tier RDR. For RDR-012 specifically, this would have
...
a **checklist item in `/conexus:rdr-close`** that asks: "Has this been verified against
real-world inputs?"
