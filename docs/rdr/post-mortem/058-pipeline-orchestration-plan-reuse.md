...
- **Orchestration reference skill**: Converting the orchestrator agent's routing tables and pipeline templates to `conexus/skills/orchestration/reference.md` preserved institutional knowledge without maintaining dead agent code.
...
- Orchestration reference skill at `conexus/skills/orchestration/reference.md`
