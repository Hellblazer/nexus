...
> **SUBSTRATE SUPERSEDED (2026-08-18 audit):** this RDR's decision text still presents a SQLite catalog with ChromaDB T3 as the greenfield architecture. That substrate was retired by RDR-152 and RDR-155; the decision here is historical record, not current architecture.
