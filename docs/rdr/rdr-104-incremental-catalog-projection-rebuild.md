...
> **SUBSTRATE SUPERSEDED (2026-08-18 audit):** this RDR's decision text still presents a SQLite catalog with FTS5-backed projections. That substrate was retired by RDR-152 and RDR-158; the decision here is historical record, not current architecture.
