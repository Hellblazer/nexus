...
#### Gap 3: Raw vector search bypasses the manifest, so deletion is what correctness relies on
...
decisive for Phase 2 and must be verified by spike before it begins; Phase 1
