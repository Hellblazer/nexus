...
wait(subspaces: [{subspace, keys_pattern?, n?, since?, announce?}], *, timeout_s=0)
                                                    -> [{subspace, tuples: [Tuple]}]
                                                            ...
                                                            # {interval_s, max} -- additive, since/announce
                                                            # together refused (SchemaViolation). See below.
