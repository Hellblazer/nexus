...
- **T2 memory**: Debugging journal via memory_put tool: content="content", project="{project}", title="debug-journal.md"; hypothesis chain via scratch_manage tool: action="promote", id="<id>", project="{project}", title="debug-hypothesis-chain.md"
