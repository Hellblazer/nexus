...
- **T2 memory**: Debugging journal via `nx memory put "content" --project {project}_active --title debug-journal.md`; hypothesis chain via `nx scratch promote <id> --project {project}_active --title debug-hypothesis-chain.md`
