...
- **T2 memory**: Phase doc read at start via `nx memory get --project {project}_active --title phase-N.md`; implementation checkpoints flushed at phase end via `nx scratch promote <id> --project {project}_active --title impl-checkpoint-phase-N.md`
