...
- `context.md` — Current project context, goals, and state
...
- [ ] Core T2 documents created (overview, context, blockers)
...
- **T2 memory**: Core PM documents: `overview.md`, `context.md`, `architecture.md`, `blockers.md` — stored via `nx memory put "content" --project {project} --title {doc}.md`
