...
- **nx pm**: Initialized via `nx pm init`; accessible via `nx pm resume`, `nx pm status`
- **T2 memory**: Core PM documents: `overview.md`, `continuation.md`, `phase-N.md`, `architecture.md` — stored via `nx memory put "content" --project {project}_active --title {doc}.md`
