...
class MemoryHandlerTest {
    ...
    void startAll() throws Exception {
        ...
        try (Connection su = pg.createConnection("")) {
            ...
            // service_tokens as the app role. Seed two BOUND tokens (one per tenant) —
            // the wildcard any-tenant grant is retired, so cross-tenant requests
            // authenticate with their own bound token.
