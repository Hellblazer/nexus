...
# re-exported here so the six function-local importers and everything else
# keep resolving through this path until this module is deleted.
from nexus.catalog.types import make_relative  # noqa: E402,F401
...
# ``_KNOWN_URI_SCHEMES`` and ``_normalize_source_uri`` moved to
# :mod:`nexus.catalog.types` (nexus-37f4v family: register-boundary
# validation is substrate-neutral and ``catalog_writes`` reaches in for
# it). Re-exported until this module is deleted.
from nexus.catalog.types import (  # noqa: E402,F401
    _CROSS_PROJECT_OVERRIDE_ENV,
    _KNOWN_URI_SCHEMES,
    _normalize_source_uri,
)


# ``CatalogEntry`` / ``CatalogLink`` moved to :mod:`nexus.catalog.types`
# (nexus-37f4v): the SURVIVING HttpCatalogClient is typed in terms of them.
# Re-exported until this module is deleted.
from nexus.catalog.types import CatalogEntry, CatalogLink  # noqa: E402,F401
...
from nexus.catalog import catalog_git as _git  # noqa: E402
