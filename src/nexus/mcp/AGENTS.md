...
| File | Server | Tools |
|---|---|---|
| `core.py` | `nexus` | 48 registered tools + 3 demoted (plain functions, no `@mcp.tool()`): `search`, `query`, `store_put/get/list`, `memory_*`, `scratch*`, `collection_list`, `plan_save/search`, and more — see the module docstring for the current roster. |
