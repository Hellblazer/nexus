...
async def _nx_answer_plan_miss(
    ...
    *,
    ...
    # Pool singleton — already created (and pre-warmed) by nx_answer step 0.
    # get_operator_pool returns the cached instance; operator_role/json_schema
    # are only used on first creation.
    pool = get_operator_pool("planner")
