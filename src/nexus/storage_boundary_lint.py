...
T2DATABASE_CONSTRUCTION_ALLOWLIST: dict[str, int] = {
    ...
    "src/nexus/commands/enrich.py": 10,    # read-only T2 access (+ routed writes); 9th = aspects-without-catalog census (nexus-mlu3k), 10th = the --sweep recovery-target existence probe (nexus-kkumv)
