...
# Schema lifecycle: the Java service runs Liquibase at startup (net63 contract).
# Liquibase owns the full DDL for the nexus schema — no _BOOTSTRAP_SQL needed here.
# See tests/db/_service_fixture.py for the nexus_svc pre-provisioning contract.
