...
_SETATTR_EXEMPT: frozenset[str] = frozenset({
    ...
    "tests/test_health_service_checks.py:2671",
...
# total by 1.
_TOTAL_BY_VALUE_IMPORT_CEILING = 77  # -1: _session_end_census.capability_census_log_path deleted at nexus-gjv9b PART 3; +1: upgrade_finish.py aspect-worker respawn (nexus-06fu4/restart-stale fix); the 3o4lt bump to 79 was reverted by switching doc_indexer to a module import
