...
ALLOWED_CALLERS: dict[tuple[str, int], str] = {
    ("src/nexus/corpus.py", 1519): (  # line shifted again (nexus-ft04v.28 item 7 follow-up: the tolerant row fetch in resolve_row_preferred added seven lines above it)
