...
_PIPEFAIL_EARLY_EXIT_EXEMPT: frozenset[str] = frozenset(
    {
        ...
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:153",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:208",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:219",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:275",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:293",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:299",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:316",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:343",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:413",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:420",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:107",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:131",
