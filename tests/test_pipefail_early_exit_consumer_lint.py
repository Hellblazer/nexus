...
_PIPEFAIL_EARLY_EXIT_EXEMPT: frozenset[str] = frozenset(
    {
        ...
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:197",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:253",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:271",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:277",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:294",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:321",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:391",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:398",
        "tests/e2e/migration-rehearsal/rehearse_package_upgrade.sh:85",
