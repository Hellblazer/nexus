...
REQUIRED_FILES = [
    ...
    "CHANGELOG.md",
    "hooks/hooks.json",
    "resources/agent-shared/RELAY_TEMPLATE.md",
    "resources/agent-shared/CONTEXT_PROTOCOL.md",
    "resources/agent-shared/ERROR_HANDLING.md",
    "resources/agent-shared/MAINTENANCE.md",
    "resources/agent-shared/README.md",
