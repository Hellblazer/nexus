...
# nexus-i711w terminal deletion: TestK1OnDeleteCascade (5 tests) retired
# WITH nexus.catalog.catalog_db — subject was CatalogDB's own SQLite FK
# schema + ALTER-on-open migration; the engine holds the same FK in
# Liquibase (Java suite coverage).
...
# nexus-i711w terminal deletion: TestO5InsertOrIgnore (2 tests) retired
# WITH nexus.catalog.catalog_db — asserted the source text/behaviour of
# CatalogDB.__init__'s collections auto-bootstrap.
