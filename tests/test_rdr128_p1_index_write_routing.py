...
# RDR-155 P4b P0a' dies-roster: this module tests the T2-daemon index-write routing — machinery
...
pytestmark = [
    pytest.mark.skipif(
        ...
        reason="dies-roster: T2-daemon index-write routing dies at the RDR-155 P4b flip",
    ),
]
