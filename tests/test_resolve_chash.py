...
class TestResolveChashT2Hit:
    def test_single_match_returns_chunkref(self, resolve_env):
        ...
        # derived from the chash, not the chash_index row's
        # chunk_chroma_id column (which is dropped by nexus-mmf5).
        # RDR-180 inverts the natural ID to the FULL chash (no truncation).
        assert ref["doc_id"] == h
